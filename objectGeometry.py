...
def policzPktyZaokraglenia(geometria, temp):
    """Funkcja ma na celu obliczenie punktow na krzywej wirnika w gornej
    jego czesci"""
...
#==============================================================================
    lopatka_XY = obliczPunktyKrzywej(geometria,pkty_XYZ[1,1:])
...
def obliczPotrzebneParametry(Goniec):  
...
#==============================================================================
    lopatka_XYZ = wspolrzednePktLopatki(geometria,temp)
