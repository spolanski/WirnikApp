...
class WirnikApp(QtGui.QMainWindow):
    ...
    def setup(self, data_dir):
        import w_menu
        self.ui = w_menu.Ui_MainWindow()
        self.ui.setupUi(self)
        self.vtk_widget = WirnikWindow(self.ui.vtk_panel, data_dir)
...
#==============================================================================
class WirnikWindow(QtGui.QFrame):
    def __init__(self, parent, data_dir):
        super(WirnikWindow, self).__init__(parent)
