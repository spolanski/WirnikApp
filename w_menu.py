...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.CALCULIX_DIR = QtGui.QLineEdit(self.groupBox_3)
        self.CALCULIX_DIR.setEnabled(True)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.CALCULIX_DIR.sizePolicy().hasHeightForWidth())
        self.CALCULIX_DIR.setSizePolicy(sizePolicy)
        self.CALCULIX_DIR.setObjectName(_fromUtf8("CALCULIX_DIR"))
        self.gridLayout.addWidget(self.CALCULIX_DIR, 1, 0, 1, 1)
        ...
        self.CALCULIX_DIR.textChanged.connect(lambda:
            self.zmienDane(self.CALCULIX_DIR,'CALCULIX_DIR'))
    ...
    def openFileDialog(self,string):
        ...
        if string == 'ccx':
            self.CALCULIX_DIR.setText(full_path)
        if string == 'cgx':
...
#==============================================================================
        ...
        self.CALCULIX_DIR.setValidator(sVal)
        self.dane['CALCULIX_DIR'] = self.CALCULIX_DIR.text()
